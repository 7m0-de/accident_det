...
FALLBACKS = [os.path.join(BASE_DIR, 'best.engine'), os.path.join(BASE_DIR, 'best (3).pt'), 'yolov10x.engine', 'yolov10x.pt', 'yolov10n.engine', 'yolov10n.pt', 'yolov8n.pt', 'yolo11n.pt']
...
HCI_TRACKER_MODEL = os.environ.get('HCI_TRACKER_MODEL', os.path.join(BASE_DIR, 'yolov10x.engine' if os.path.exists(os.path.join(BASE_DIR, 'yolov10x.engine')) else 'yolov10x.pt'))
HCI_EVENT_MODEL = os.environ.get('HCI_EVENT_MODEL', os.path.join(BASE_DIR, 'best.engine' if os.path.exists(os.path.join(BASE_DIR, 'best.engine')) else 'best.pt'))
