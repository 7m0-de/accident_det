...
- **Custom YOLOv10 Pipeline:** Dedicated real-time detection of vehicles, motorcycles, active fires, and accidents.
...
- **Fire & Smoke Detection:** Dynamic region-of-interest (ROI) and full-frame monitoring for fires and smoke using a dedicated YOLO model.
...
- `logic.py`: Core processing engine orchestrating the YOLOv10 tracker, Kalman motion analyzer, Bayesian risk assessment, and fire detector.
